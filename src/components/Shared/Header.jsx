         ...
         {/* All Leads Navbar  */}
           <section className='w-full '> 
            ...
            <div className='text-blue-500 left-0  '> 
              <NavLink className={`mr-2 btn-design hover:text-neutral-100 p-2 px-3 rounded-sm`} 
              to={'/followup-leads'}> My Follow-up </NavLink>  
              <NavLink className={' btn-design hover:text-neutral-100 py-2 px-3 rounded-sm'} 
           ...
           <button type='submit' className='  px-2 py-2  border border-blue-300 hover:bg-btn-color hover:text-black text-blue-500 cursor-pointer  rounded-tr-md rounded-br-md ' >  Search  </button>
           </div>

             {/* Filter section and Create Leads  */}
             <div className='flex flex-col'>
                  <div className='flex whitespace-nowrap justify-center'>
                  <label htmlFor='filter_leads_modal' className={' mr-2 btn-design hover:text-neutral-100  py-2 px-3 rounded-sm'} 
                  > Filter Leads  </label> 
                  <FilterLeadsModal> </FilterLeadsModal> 
                  
                   <NavLink className={' mr-2 btn-design  hover:text-neutral-100  py-2 px-3 rounded-sm'} 
                ...
                <div className=' flex justify-end items-center  '>
                 <>
                 <label htmlFor="import_modal" className={' btn-design mr-3  text-slate-700 hover:text-white py-2 px-3 rounded-sm mt-2'} > Imports </label> 
                  <ImportModal/>
                 </>
                  <>
                  <label htmlFor='create_newlead_modal' className={' btn-design text-slate-700 hover:text-white py-2 px-2 rounded-sm mt-2'} > Create New Leads </label> 
