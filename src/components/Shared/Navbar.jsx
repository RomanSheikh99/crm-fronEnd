      ...
      <div className="w-full  bg-slate-900 mx-auto rounded-bl-sm rounded-br-sm  px-3 py-2 flex justify-between text-neutral-100">
        ...
        <div className=" flex items-center py-0 my-0 gap-2 h-8">
          ...
          <div className="dropdown dropdown-end">
            <label
              tabIndex={0}
              className=" rounded-md p-1 items-center border-none bg-slate-900 hover:bg-slate-700 flex text-neutral-400 hover:text-neutral-200 cursor-pointer"
            >
              {" "}
            ...
            >
              ...
              <li>
                <Link to="/dashboard/marketers"> Dashboard </Link>
              </li>
              <li>
