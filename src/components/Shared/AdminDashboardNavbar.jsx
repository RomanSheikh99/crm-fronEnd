...
const AdminDashboardNavbar = () => {
  ...
  return (
    <div className={`w-full ${state.theme == "DARK" ? "dark" : "light"}`}>
      <div
        className={`w-full  mx-auto h-16 px-3 py-2 flex justify-between items-center ${
      ...
      >
        ...
        <div className="flex items-center  py-0 my-0 gap-2">
          <div className="dropdown dropdown-end ">
            <label tabIndex={1} className=" mx-2 ">
              {" "}
          ...
          <div className="dropdown dropdown-end">
            <label
              ...
              className={`${
                state.theme == "DARK" ? "dark" : "light"
              } rounded-md p-1 items-center border-none hover:bg-slate-700 flex hover:text-neutral-200 cursor-pointer`}
            >
              {" "}
              Roman Sheikh <FaCaretDown />{" "}
            </label>
            <ul
              tabIndex={0}
              className="dropdown-content text-slate-900 font-semibold menu p-2 shadow  h-52 bg-neutral-100 rounded-md ml-1 mt-1 w-52"
            >
              <li>
                <Link to="/"> View profile</Link>
              </li>
              <li>
                <Link to="/"> Your gmail </Link>
              </li>
              <li>
