            ...
            <section >
                <div className="flex justify-between px-2 items-center py-3  ">
                  <div className='flex'>
                    ...
                    <button type='submit' className='  px-2 py-0  h-10 border border-blue-300 hover:bg-blue-300 hover:text-white text-blue-500 cursor-pointer  rounded-tr-md rounded-br-md ' >  Search  </button>
                  </div>
